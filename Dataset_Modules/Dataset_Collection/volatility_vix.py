"""
col_volatility_vix.py
----------------------
Single-column dataset feature.

Column : Volatility_CBOE Volatility Index (VIX)
Source : Yahoo Finance – ^VIX  (CBOE VIX – S&P 500 implied 30-day volatility)
Output : Dataset_Modules/dataset_output/2015-2025_volatility_vix.csv

Run standalone:
    python col_volatility_vix.py
...
def collect(start_date: str, end_date: str, date_range: pd.DatetimeIndex, interval: str = "1d") -> pd.DataFrame:
    ...
    Returns:
        ...
        ``Volatility_CBOE Volatility Index (VIX)`` holding the daily
