"""
col_currency_btc_price.py
--------------------------
Single-column dataset feature.

Column : BTC/USD
Source : Yahoo Finance – BTC-USD  (Bitcoin closing price in US Dollars)
Output : Dataset_Modules/dataset_output/2015-2025_currency_btc_price.csv

Run standalone:
    python col_currency_btc_price.py
...
def collect(start_date: str, end_date: str, date_range: pd.DatetimeIndex, interval: str = "1d") -> pd.DataFrame:
    ...
    Args:
        ...
        date_range: Full pandas DatetimeIndex to re-index the result onto.
            Dates not covered by the source are left as NaN.
...
def main() -> None:
    """Parse CLI arguments, collect BTC/USD price data, and save the output CSV."""
    import argparse
