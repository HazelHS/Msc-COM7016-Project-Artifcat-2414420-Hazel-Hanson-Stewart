...
def collect(start_date: str, end_date: str, date_range: pd.DatetimeIndex, freq: str = "1d") -> pd.DataFrame: # (Anthropic, 2026)
    """Fetch the daily Bitcoin transaction count from the Blockchain.info API.
    ...
    Returns:
        ...
        "Onchain Transaction Count" containing the number of confirmed
...
def main() -> None: # (Anthropic, 2026)
    """Parse CLI arguments, collect transaction count data, and save the output CSV.
